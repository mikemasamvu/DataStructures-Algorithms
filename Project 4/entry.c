...
Date: 11/01/2023
Purpose: Contains fuctions for my entry struct functions
*/
...
// Parameters: file, max_id, battlefield count
// Returns: entry struct
// Purpose: Function to read file
player_entry entry_read(FILE *in, int max_id, int battlefields)
{
    player_entry result;
...
// Parameters: entry struct
// Returns: nothing
// Purpose: Destroy entry
void entry_destroy(player_entry *e)
{
    if (e != NULL)
    {
        free(e->id);
